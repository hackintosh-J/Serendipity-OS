...
const GlanceView: React.FC = () => {
  ...
  return (
    <div className="h-full w-full bg-gradient-to-br from-indigo-100 via-sky-100 to-teal-100 dark:from-indigo-900/70 dark:via-sky-900/70 dark:to-teal-900/70 overflow-y-auto p-4 sm:p-6 md:p-8">
