      ...
      <header className="flex-shrink-0 bg-card-glass backdrop-blur-lg border-b border-border p-2 flex items-center gap-2">
        <form onSubmit={handleNavigate} className="flex-grow">
          <input
            ...
            className="w-full px-3 py-1.5 bg-input/80 border border-border rounded-lg text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-ring transition-colors"
          />
        </form>
        <button onClick={handleOpenInNewTab} className="px-3 py-1.5 text-sm bg-secondary text-secondary-foreground rounded-lg hover:bg-secondary/80 transition-colors">在新标签页打开</button>
      </header>
