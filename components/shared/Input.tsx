...
const Input = React.forwardRef<HTMLInputElement, InputProps>((props, ref) => {
  const baseClasses = "w-full px-3 py-2 bg-white/80 border border-gray-300 rounded-lg text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors";
